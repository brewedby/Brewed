  ...
  predictionLenses: [
    {
      ...
      tagline: 'Mains demand, plus expected sides and drinks per order.',
      drivers: ['Lunch & dinner rushes', 'Hot weather → more drinks', 'Evening events skew higher mains'],
    },
  ],
  ...
  predictionLenses: [
    {
      ...
      tagline: 'Whole/slice mix and dough portion guidance.',
      drivers: ['Lunch & dinner peaks', 'Family events drive whole-pizza share', 'Cold weather softens demand'],
    },
  ],
  weatherSensitivity: 'medium',
  ...
  predictionLenses: [
    {
      ...
      tagline: 'Mains volume with sides + drinks attachment rates.',
      drivers: ['Meal-time rushes', 'Footfall sensitivity', 'Hot weather lifts drinks attachment'],
    },
  ],
  weatherSensitivity: 'medium',
  ...
  predictionLenses: [
    {
      ...
      drivers: [
        'Hot, sunny days → strong demand',
        'Rain → footfall collapses',
        'Family / school-holiday events lift baseline',
      ],
    },
  ],
  weatherSensitivity: 'high',
